...
def do_bdd100k_seg_evaluation(
    ...
    if output_folder:
        torch.save(results, os.path.join(output_folder, "bdd100k_seg_results.pth"))
...
def prepare_for_coco_detection(predictions, dataset):
    ...
    for image_id, prediction in enumerate(predictions):
        ...
        img_info = dataset.get_img_info_by_id(image_id)
        ...
        # see bdd100k_seg.py for type to id conversion
...
def prepare_for_coco_keypoint(predictions, dataset):
    ...
    for image_id, prediction in enumerate(predictions):
        ...
        # TODO replace with get_img_info_by_id?
